...
var (
	...
	RecordRejected        = NewError(http.StatusInternalServerError, 200522, "含有已经被驳回的申请，请重新选择")
	ReturnStatusError     = NewError(http.StatusInternalServerError, 200523, "含有非归还的记录，请重新选择")
